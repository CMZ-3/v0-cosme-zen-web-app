...
export const fdaRegistrations = pgTable("fda_registrations", {
  ...
  // Extended detail columns (added in migration)
  licenseNumber: text("licenseNumber"),
  fdaProductName: text("fdaProductName"),
  tradeNameEn: text("tradeNameEn"),
  productNameSuffix: text("productNameSuffix"),
  cosmeticForm: text("cosmeticForm"),
  usageFormat: text("usageFormat"),
  applicationArea: text("applicationArea"),
  productPurpose: text("productPurpose"),
  containerType: text("containerType"),
  productForm: text("productForm"),
  usageInstructions: text("usageInstructions"),
  warnings: text("warnings"),
  combinedRegistrationNos: text("combinedRegistrationNos"),
  registrationDate: text("registrationDate"),
  manufacturerAddress: text("manufacturerAddress"),
  manufacturerLicense: text("manufacturerLicense"),
  manufacturerStorageAddress: text("manufacturerStorageAddress"),
  importerName: text("importerName"),
  importerAddress: text("importerAddress"),
  formulaId: text("formulaId"),
  customerId: text("customerId"),
  approvalComment: text("approvalComment"),
  rejectionReason: text("rejectionReason"),
  feeNotes: text("feeNotes"),
  notes: text("notes"),
  createdBy: text("createdBy"),
  // Original columns
